...
|:-----|:-----:|
Github Actions: |  
bootstrap | [![Build Status](https://github.com/steve-cs/action-test/workflows/CI/badge.svg)](https://github.com/steve-cs/action-test/tree/master/.github/workflows)
Travis CI: | 
